...
$sql = "SELECT * FROM add_product WHERE category='$category' LIMIT $productsPerPage OFFSET $offset";
$result = $conn->query($sql);

// Query to count the total number of products
$totalProductsQuery = "SELECT COUNT(*) as total FROM add_product WHERE category='$category'";
